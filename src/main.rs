...
use tpath::join::{hash_join, hash_join_2, hash_join_edge_node};
...
fn main() {
    ...
    if query_list.contains(&1) {
        ...
        println!("{:?},q1,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q1.len());
    }
    ...
    if query_list.contains(&4) {
        ...
        println!("{:?},q4,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, 0, exec_time.elapsed().as_millis(), &q4.len());
    }
    ...
    if query_list.contains(&5) {
        ...
        println!("{:?},q5,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q5.len());
    ...
    if query_list.contains(&6) {
        ...
        //log(format!("st,t,#q6:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q6.len());
        println!("{:?},q6,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q6.len());
    }
    if query_list.contains(&0) {
        ...
        //log(format!("st,t,#q6:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q6.len());
        println!("{:?},q6-p,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q6.len());
    }
    ...
    if query_list.contains(&7) {
        ...
        println!("{:?},q7,{}_{},{:?},{:?},{:?}", num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q7.len());
    }
    ...
    if query_list.contains(&0) {
        ...
        let q7: Vec<((i32, i32), (i32, i32))> = q7.into_par_iter()
            ...
            .collect();
        log(format!("q7[(x,t),(z,t)]{:?}", &q7), 5, debug_flag);
        println!("{:?},q7-p,{}_{},{:?},{:?},{:?}", num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q7.len());
    }
    if query_list.contains(&8) {
        ...
        println!("{:?},q8,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q8.len());
    }
    ...
    if query_list.contains(&0) {
        ...
        let q8: Vec<((i32, i32), (i32, i32))> = q8.into_par_iter()
            ...
            .collect();
        log(format!("q8[(x,t),(z,t)]{:?}", &q8), 5, debug_flag);
        println!("{:?},q8-p,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q8.len());
    }
    ...
    if query_list.contains(&9) {
        ...
        //log(format!("st,t,#q9:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q9.len());
        println!("{:?},q9,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q9.len());
    }
    ...
    if query_list.contains(&0) {
        ...
        log(format!("q9[(x,t)]{:?}", &q9), 5, debug_flag);
        //log(format!("st,t,#q9:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q9.len());
        println!("{:?},q9-p,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q9.len());
    }
    ...
    if query_list.contains(&10) {
        ...
        //log(format!("st,t,#q10:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q10.len());
        println!("{:?},q10,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q10.len());
    }
    ...
    if query_list.contains(&0) {
        ...
        log(format!("10[(x,t)]{:?}", &q10), 5, debug_flag);
        //log(format!("st,t,#q10:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q10.len());
        println!("{:?},q10-p,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q10.len());
    }
    ...
    if query_list.contains(&11) {
        ...
        //log(format!("st,t,#q11:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q11.len());
        println!("{:?},q11,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q11.len());
    }
    ...
    if query_list.contains(&0) {
        ...
        log(format!("q11[(x,t)]{:?}", &q11), 5, debug_flag);
        //log(format!("st,t,#q11:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q11.len());
        println!("{:?},q11-p,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q11.len());
    }
    ...
    if query_list.contains(&12) {
        ...
        //log(format!("st,t,#q11:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q11.len());
        println!("{:?},q12,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q12.len());
    }
    ...
    if query_list.contains(&0) {
        ...
        log(format!("q12[(x,t)]{:?}", &q12), 5, debug_flag);
        //log(format!("st,t,#q11:{:?},{:?},{:?}",struct_time,exec_time.elapsed().as_millis(),&q11.len());
        println!("{:?},q12-p,{}_{},{:?},{:?},{:?}", &num_thred_, data_name, qt, struct_time, exec_time.elapsed().as_millis(), &q12.len());
    }
}
